...
class TestCommunicate(unittest.TestCase):
    ...
    @patch("{{cookiecutter.slug}}.lib.run_commands.Popen", side_effect=OSError("boom"))
...
class TestAdvanced(unittest.TestCase):
    ...
    @patch("{{cookiecutter.slug}}.lib.run_commands.os.set_blocking", return_value=None)
    @patch("{{cookiecutter.slug}}.lib.run_commands.select.select")
    @patch("{{cookiecutter.slug}}.lib.run_commands.subprocess.Popen")                  # bottom → first arg
